...
def parse_args(script):
    ...
    parser.add_argument('--dataset', default='CUB', help='CUB/Dog/Car/Air')
    parser.add_argument('--model', default='Conv4',
                        help='model: Conv4 / ResNet12')  # 50 and 101 are not used in the paper
    parser.add_argument('--method', default='protonet',
                        help='protonet/matchingnet/relationnet{_softmax}')  # relationnet_softmax replace L2 norm with softmax to expedite training, maml_approx use first-order approximation in the gradient for efficiency
    parser.add_argument('--train_n_way', default=5, type=int, help='class num to classify for training')
    parser.add_argument('--test_n_way', default=5, type=int, help='class num to classify for testing (validation) ')
    parser.add_argument('--n_shot', default=5, type=int, help='number of labeled data in each class, same as n_support')
    parser.add_argument('--n_query', default=16, type=int, help='number of query images per class')
    ...
    parser.add_argument('--apcnn', action='store_true', help='use apcnn ')  # use our method
